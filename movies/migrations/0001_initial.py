# Generated by Django 3.1.1 on 2020-10-06 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('japantitle', models.CharField(default='', max_length=100, verbose_name='Японское название')),
                ('description', models.TextField(verbose_name='Описание')),
                ...
                ('country', models.CharField(default='Япония', max_length=30, verbose_name='Страна')),
                ('word_premiere', models.DateField(default=datetime.date.today, verbose_name='Дата выхода')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.Hero', verbose_name='Режисер')),
                ('genre', models.ManyToManyField(to='movies.Genre', verbose_name='жанры')),
                ('heroes', models.ManyToManyField(related_name='film_hero', to='movies.Hero', verbose_name='герои')),
            ],
            options={
                'verbose_name': 'Аниме',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.movie', verbose_name='аниме')),
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.ratingstar', verbose_name='оценка')),
            ],
            options={
